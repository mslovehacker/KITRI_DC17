          ...
          <!-- start: content -->
            <div id="content">
                ...
                <div class="panel-heading bg-white border-none" style="margin-bottom: 20px;">
                   	<h4><span class="icon-notebook icons"></span> 출장보고서</h4>
                   	 	<h4><font color="blue"><a href="${root }/appr/insertgian.html">기안서</a>　<a href="${root }/appr/insertvacation.html">휴가서</a>　<a href="${root }/appr/insertbalju.html">발주서</a></font></h4>
	                   				...
	                   				<table style="margin-left: 30px; width: 97%;">
	                   					<tbody>
	                   						<tr>
	                   							...
	                   							<td style="width: 37%; text-align: center;"><label>4000</label>-<label>XXXX</label></td>
	                   							<td style="width: 12%; text-align: center;">문서종류</td>
	                   							<td style="width: 36%; text-align: center;"><label>출장보고서</label></td>
	                   						</tr>
	                   						<tr>

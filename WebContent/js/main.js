(function (jQuery) {
    ...
    var update = function () {
        ...
        datetime.html(pad(date.getHours()) + ':' + pad(date.getMinutes()));
        datetime2.html(date.getFullYear() + '년 ' + (date.getMonth() + 1) + '월 ' + date.getDate() + '일 ' + weekName[date.getDay()] + '요일');
    };

    /*占쎈닚域뱀눘�뻻揶쏉옙 燁삳똻�뒲占쎈뱜
    function getTime() { 
    	now = new Date(); 
    	dday = new Date(now.getFullYear(),now.getMonth() + 1,now.getDate(),18,00,00); // 占쎌뜚占쎈릭占쎈뮉 占쎄텊筌욑옙, 占쎈뻻揶쏉옙 占쎌젟占쎌넇占쎈릭野껓옙 �룯�뜄�뼊占쎌맄繹먮슣占� 疫꿸퀣�뿯.
    	...
    	datetime3.html('占쎈닚域뱀눊�돱筌욑옙 ' + hRound + '占쎈뻻揶쏉옙 ' + mRound + '�겫占� ' + sRound + '�룯�뜃占� 占쎄텚占쎈릭占쎈뮸占쎈빍占쎈뼄.');
